...
def process_particle_trace(trace_path):
    ...
    NUM_REPS_DIFF = data.NUM_REPS_OUTER_COIL - 2 # 2 loops are already in the top and bottom
    ...
    finalTrace.to_csv(data.DIR_PATH / 'outer_coil_data_stitched' / f'outer_bcoil_particle_{pnum:02d}_stitched.csv', index=False)
